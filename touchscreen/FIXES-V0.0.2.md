...
Update the scale to V0.0.33. Open Wi-Fi touchscreen setup on its web page, select Add touchscreen, and save the scale address on the touchscreen. Enter its 12-character code on the scale page. BLE e-paper pairing is separate.
