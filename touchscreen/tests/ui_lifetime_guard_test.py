...
checks = {
    ...
    "mDNS results use generation gate":
        "ui_discovered_options_for_generation(options, a.ui_generation);" in main,
    "Wi-Fi results use generation gate":
        "a.ui_generation" in main and
        "ui_networks(options[0] ? options : \"No networks found\"," in main,
    "late async messages use generation gate":
        main.count("ui_message_for_generation(") >= 4,
