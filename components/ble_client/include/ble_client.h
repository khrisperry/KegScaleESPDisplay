...
enum {
    BLE_DISPLAY_FLAG_SHOW_BEER_NAME = 1U << 0,
    BLE_DISPLAY_FLAG_SHOW_GALLONS = 1U << 1,
    BLE_DISPLAY_FLAG_SHOW_PERCENT = 1U << 2,
...
#define BLE_DISPLAY_FLAGS_DEFAULT \
    (BLE_DISPLAY_FLAG_CONFIG_PRESENT | \
     BLE_DISPLAY_FLAG_SHOW_BEER_NAME | \
     BLE_DISPLAY_FLAG_SHOW_GALLONS | \
     BLE_DISPLAY_FLAG_SHOW_PERCENT | \
     BLE_DISPLAY_FLAG_SHOW_SERVING_SIZE | \
